...
class Master(MasterBase):
    def __init__(self, rtio_clk_freq=125e6, hw_rev=None, **kwargs):
        if hw_rev is None:
            hw_rev = "v2.0"
        ...
        eem.DIO.add_std(self, 0, ttl_serdes_7series.InOut_8X, ttl_serdes_7series.Output_8X, edge_counter_cls=edge_counter.SimpleEdgeCounter)
        ...
        eem.DIO.add_std(self, 7, ttl_serdes_7series.InOut_8X, ttl_serdes_7series.Output_8X, edge_counter_cls=edge_counter.SimpleEdgeCounter)
        eem.DIO.add_std(self, 8, ttl_serdes_7series.InOut_8X, ttl_serdes_7series.Output_8X, edge_counter_cls=edge_counter.SimpleEdgeCounter)
